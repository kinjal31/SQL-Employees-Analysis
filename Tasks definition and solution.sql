...
#salaries, employees,dept_emp,t_deptartments tables 
# line chart 
# gender, dept name,salary, calendar year columns in data s
# having year<=2002
# group by 3 columns s
# show avg salary of m and f for each dept each year  
